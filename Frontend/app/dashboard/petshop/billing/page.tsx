...
export default function PetshopBillingPage() {
  ...
  const plans: Plan[] = [
    {
      ...
      description: "Ideal para empezar y dar a conocer tus productos.",
      isCurrent: true,
      features: [
        { text: "Publicación ilimitada de productos", included: true },
        { text: "Gestión de inventario y ventas", included: true },
        { text: "Comisión del 8% en cada venta", included: true },
        { text: "Visibilidad estándar en la plataforma", included: true },
        { text: "Perfil de tienda personalizable", included: false },
        { text: "Acceso a reportes de ventas avanzados", included: false },
    ...
    },
    {
      ...
      description: "Para tiendas que buscan maximizar sus ventas y visibilidad.",
      isCurrent: false,
      features: [
        { text: "Publicación ilimitada de productos", included: true },
        { text: "Gestión de inventario y ventas", included: true },
        { text: "Cero comisiones por ventas", included: true },
        { text: "Visibilidad destacada en toda la plataforma", included: true },
        { text: "Perfil de tienda completamente personalizable", included: true },
        { text: "Acceso a reportes de ventas avanzados", included: true },
      ...
      <div className="p-6">
        <header className="mb-8">
            ...
            <p className="text-muted-foreground mt-2">
              Elige el plan que mejor se adapte a tu Petshop. Pásate a Profesional para eliminar comisiones y vender más.
            </p>
        </header>
