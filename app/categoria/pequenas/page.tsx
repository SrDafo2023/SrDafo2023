...
export default function PequenasPage() {
  ...
  const categories = ["Todos", "Alimento", "Hábitat", "Accesorios", "Alimentación", "Refugio", "Higiene"]
      ...
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white py-8">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-4xl font-bold">Pequeñas Mascotas</h1>
              <p className="text-xl text-purple-100">Conejos, hamsters, cobayas y más</p>
            </div>
          </div>
        </div>
      </div>
